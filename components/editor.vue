<template>
	<view>
		<!-- 导航栏 -->
		<statusBar>
			<text slot="pageTitle" class="font-title mt-1">编辑器</text>
			<view v-if="!isWechat" slot="right-text" class="flex just-content-around">
				<view @tap="saveValidation">
					<text style="color: #59C65D; margin-top: 3rpx;" class="font-title">保存</text>
				</view>
			</view>
		</statusBar>
		...
		<view v-if="isWechat" @click="saveValidation"
			...
			<text class="icon iconfont h6 font-white">保存</text>
		</view>
		<!-- #endif -->
		...
		data() {
			return {
				...
				functionList: [
					...
					{
						img: '/static/editor/function/weachat.png',
						title: '添加微信号',
						value: '微信号',
						w: '42',
						h: '35',
					...
					{
						img: '/static/editor/function/qr.png',
						title: '添加微信二维码',
						value: '二维码',
						w: '37',
						h: '36',
					...
					{
						img: '/static/editor/function/phone.png',
						title: '添加电话',
						value: '电话',
						w: '33',
						h: '48',
					...
					{
						img: '/static/editor/function/qq.png',
						title: '添加QQ号',
						value: 'qq',
						w: '43',
						h: '51',
					...
					{
						img: '/static/editor/function/name.png',
						title: '添加昵称',
						value: '昵称',
						w: '43',
						h: '33',
					...
					{
						img: '/static/editor/function/city.png',
						title: '添加城市',
						value: '城市',
						w: '39',
						h: '39',
					...
					{
						img: '/static/editor/function/gender.png',
						title: '添加性别',
						value: '性别',
						w: '41',
						h: '41',
